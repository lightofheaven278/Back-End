...
public class StudentImp {
    ...
    public static void updateStudentInfo() {
        ...
        if (index != -1) {
            ...
            studentList.get(index).setBirthday(Student.isValidDate(input));
            ...
            studentList.get(index).calAge(input);
    ...
    public static void searchStudentInfoByName() {
        ...
        System.out.printf("%-15s%-20s%-20s%-15s%-15s%-15s%-15s%-20s%-15s%-20s\n",
                "Student ID", "Student Name", "Birthday", "Age", "Sex", "HTML Mark", "CSS Mark",
                "Javascript Mark", "Avg Mark", "Rank");
        List<Student> searchStudent = studentList.stream().
                filter(student -> student.getStudentName().toLowerCase().contains(searchName.toLowerCase())).toList();
        searchStudent.forEach(Student::displayData);
//        for (Student student : studentList) {
